...
from emprestimos.views import home, cadastrar_livro, fazer_emprestimo, listar_livros, historico_de_emprestimos, detalhar_livro, deletar_livro, atualizar_livro, emprestar_livro, devolver_livro
...
urlpatterns = [
    ...
    path('emprestar_livro/<int:id>', emprestar_livro, name="emprestar_livro"),
    path('devolver_livro/<int:id>/', devolver_livro, name="devolver_livro"),
]
